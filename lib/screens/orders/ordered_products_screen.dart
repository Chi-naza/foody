    ...
    return Scaffold(
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Obx(() {
            // if cart is empty
            return productController.allOrdersList.isEmpty
                ? Column(
                      ...
                      SizedBox(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            var orderedItem =
                                productController.allOrdersList[index];
                            ...
                            return InkWell(
                              ...
                              child: CartItemWidget(
                                ...
                                productName: orderedItem.product.name
                                        .substring(0, 1)
                                        .toUpperCase() +
                                    orderedItem.product.name.substring(1),
                                productIndex: index,
